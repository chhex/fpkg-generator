...
public class DummyMapperInterfaceGenerator implements SchemaBasedVisitor<StringBuffer> {
    ...
    public DummyMapperInterfaceGenerator(String nameSpace, String templatesRootDir) {
        this.groupDir = new STGroupDir(FilenameUtils.concat(templatesRootDir, "java/modelmapper"));
    ...
    public void postvisit(Pkg pkg) {
        try {
            writeOutputFile( "ModelMapper.java", NameConversion.toJavaName(pkg.getName()).toLowerCase(), 
